...
\title{Activations, Not Weights: Incoherence Processing Enables\\
...
\end{enumerate}
We additionally chart the reachable bit-width frontier and quantify the model-size reduction.
...
task retention and $2.7\times$ model compression. The recipe is simple, training-free, and
reproducible.
