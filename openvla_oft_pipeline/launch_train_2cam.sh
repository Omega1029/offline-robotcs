...
#   01B_train_openvla_oft_2cam.py and 02_eval_libero.py before training.
#
# USAGE:
...
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/openvla_oft_libero_2cam}"
RUN_NAME="${RUN_NAME:-openvla_oft_libero_2cam_$(date +%Y%m%d_%H%M%S)}"
